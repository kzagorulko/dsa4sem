package ru.zagorulko.exercise3.database;
...
import ru.zagorulko.exercise3.Student;
...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public ru.zagorulko.exercise3.database.dao.StudentDAO getStudentDAO() throws SQLException{
        if(StudentDAO == null){
